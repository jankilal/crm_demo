...
<section id="middle">
   ...
   <header id="page-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">TransactionsReports Edit</li>
      </ol>
   </header>
   <!-- /page title -->
      ...
      <div class="col-md-12">
         <div class="panel panel-default">
            <div class="panel-heading panel-heading-transparent">
               <strong>Edit TransactionsReports</strong>
            ...
            <div class="panel-body">
               <form method="post" enctype="multipart/form-data" data-success="Sent! Thank you!">
                  <fieldset>
                  <?php
                     foreach ($edit_transactions_reports as $res) 
                     {
                     ?>
                 <div class="row">
                              ...
                              <label> Paid By <span class="text-danger"> *</span></label>
                                  <select class="form-control select_box select2-hidden-accessible" style="width: 100%" name="paid_by" tabindex="-1" aria-hidden="true" >
                                    ...
                                    <?php
                                       ...
                                       {
                                          ?>
                                         <option <?php if($u_val->user_id == $res->paid_by){ echo "selected"; } ?> value="<?php echo $u_val->user_id; ?>"><?php echo $u_val->user_full_name; ?></option>
                                        <?php 
                                       }
                                       ?>
                                  </select>
