...
<section id="middle">
   ...
   <header id="page-header">
      <h1>Answered <small>Control panel</small></h1>
      <ol class="breadcrumb">
         <br>
         <li><a href="<?php echo base_url();?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
         <li><a href="<?php echo base_url();?>tickets/answered">Answered</a></li>
         <li class="active">Answered Add</li>
      </ol>
   </header>
   <!-- /page title -->
   ...
   <div class="col-md-12">
      <div class="panel panel-default">
         <div class="panel-heading panel-heading-transparent">
            <strong>Add Answered</strong>
            <div class="pull-right box-tools">
               <a href="<?php echo base_url();?>tickets/answered" class="btn btn-teal btn-sm">Back</a>                           
            </div>
         </div>
