      ...
      <div class="panel-body">
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="col-md-4 col-sm-4">
                  ...
                  <input name="lead_name" placeholder="Enter lead Name" class="form-control" type="text" id="lead_name" value="" />
               </div>
               <div class="col-md-4 col-sm-4">
                  <label>Lead Status</label>
                     <select class="form-control" name="lead_status_id" id="lead_status_id">
                        ...
                        <?php
                        $lead_status = $this->leads_model->getALLleadsStatusList();
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="col-md-4 col-sm-4">
                  <label>Loction</label>
                  <input name="city" placeholder="Enter Location" class="form-control" type="text" id="city" value="" />
               </div>
               <!-- <div class="col-md-4 col-sm-4">
                  <label>Quotations Status </label>
                     <select class="form-control" name="quotations_status" id="quotations_status">
                        <option value="">Select Quotations Status</option>
               ...
               <!-- <div class="col-md-4 col-sm-4 project">
                  ...
                  <input type="hidden" name="response_levels" id="response_levels" value="0">
               </div> -->
            </div>
         </div><br>
         <div class="row">
            <div class="col-md-12">
               <div class="col-md-3">
                  <button class="btn btn-primary btn-sm" id="search_btn">Search</button>
               </div>
            </div>
         </div><br>
...
<script type="text/javascript" src="<?= base_url(); ?>webroot/js/datatables/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="<?= base_url(); ?>webroot/js/datatables/dataTables.bootstrap.min.js"></script>
<script type="text/javascript">
      var table = '';
      if (jQuery().dataTable) {
          ...
          "dataType": "json",
           "data": function ( data ) {
            data.show_leads_by = $('#showLeadsBy').val();
               data.filter_by = {'lead_name':$('#lead_name').val(), 'lead_status_id':$('#lead_status_id').val(),'industry':$('#industry').val(),'city':$('#city').val(),'showLeadsBy':$('#showLeadsBy').val()};
           },
