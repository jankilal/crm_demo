...
class Leads_model extends CI_Model 
{
    ...
    {       
		...
		{
			if($_POST['filter_by']['lead_name'] != '')
			{
				$lead_name   = $_POST['filter_by']['lead_name'];
				$sql[] = "a.lead_name = '".$lead_name."'";
			}
			if($_POST['filter_by']['lead_status_id'] != '')
			{
				$lead_status_id   = $_POST['filter_by']['lead_status_id'];
				$sql[] = "a.lead_status_id = '".$lead_status_id."'";
			}
			if($_POST['filter_by']['industry'] != '')
			{
				$industry   = $_POST['filter_by']['industry'];
				$sql[] = "a.industry = '".$industry."'";
			}
			if($_POST['filter_by']['city'] != '')
			{
				$city   = $_POST['filter_by']['city'];
				$sql[] = "a.city = '".$city."'";
			}
			if($_POST['filter_by']['quotations_status'] != '')
			{
				$quotations_status   = $_POST['filter_by']['quotations_status'];
				$sql[] = "a.quotations_status = '".$quotations_status."'";
			}
		}
