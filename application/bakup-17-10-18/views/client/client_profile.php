...
<header id="page-header">
   <h1>Profile <small>Control panel</small></h1>
       ...
       <br>
            ...
            <li><a href="<?php echo base_url();?>client">Profile</a></li>
            ...
            <div class="panel-body">
               <form method="post" onsubmit="return checkProfileUpdate()" enctype="multipart/form-data" data-success="Sent! Thank you!">
                        ...
                        <div class="form-group">
                           <div class="col-md-4 col-sm-4">
                              <label>Name<span class="text-danger"> *</span></label>
                                <input name="client_name" class="form-control" type="text" id="client_name" value="<?php echo $res->user_full_name; ?>" />
                                <?php echo form_error('client_name','<span class="text-danger">','</span>'); ?>
                           </div> 
                           <div class="col-md-4 col-sm-4">
                              <label>Email<span class="text-danger"> *</span></label>
                                <input name="client_email" onchange="check_email_address(this.value)" class="form-control" type="text" id="client_email" value="<?php echo $res->user_email; ?>" />
                                <input type="hidden" id="validate_email">
                                <span style="color: red;" id="error_email"></span>
                           </div>
                            <div class="col-md-4 col-sm-4">
                              <label>client Phone<span class="text-danger"> *</span></label>
                                <input name="client_phone" class="form-control" type="text" id="client_phone" value="<?php echo $res->user_phone; ?>" />
                         ...
                         <div class="form-group"> 
                            <div class="col-md-4 col-sm-4">
                             <label>City<span class="text-danger"> *</span></label>
                                <input name="client_city" class="form-control" type="text" id="client_city" value="<?php echo $res->user_city; ?>" />
                                <?php echo form_error('client_city','<span class="text-danger">','</span>'); ?>
                           </div>
                            <div class="col-md-4 col-sm-4">
                              <label>Zip Code<span class="text-danger">*</span></label>
                                <input type="text" class="form-control masked" data-format="99999" data-placeholder="12345" placeholder="Zip code" name="client_zip_code" value="<?php echo  $res->user_zip_code; ?>"  >
                                <?php echo form_error('client_zip_code','<span class="text-danger">','</span>'); ?>
                           </div>
                            <div class="col-md-4 col-sm-4">
                              <label>Address<span class="text-danger">*</span></label>
                               <textarea name="client_address" class="form-control"><?php echo $res->user_address; ?></textarea>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4">
                              <label>client Website<span class="text-danger"></span></label>
                                <input type="text" name="client_website" placeholder="http://yourclientsite.com" value="<?php echo $res->user_website; ?>" class="form-control">
                             ...
                             <div class="col-md-4 col-sm-4">
                               <label>Fax Number</label>
                                <input name="client_fax" class="form-control" type="text" id="client_fax" value="<?php echo $res->user_fax; ?>" />
                         ...
                         <div class="form-group">
                            <div class="col-md-4 col-sm-4">
                              <label>Skype Id<span class="text-danger"></span></label>
                                <input type="text" name="client_skype_id" value="<?php echo $res->user_skype_id;?>" class="form-control">
                                <?php echo form_error('client_skype_id','<span class="text-danger">','</span>'); ?>
                            </div>
                            <div class="col-md-4 col-sm-4">
                              <label>Facebook Url</label>
                                <input name="client_fb_id" class="form-control" type="text" id="client_fb_id" value="<?php echo $res->user_facebook_url; ?>" />
                                  <?php echo form_error('client_fb_id','<span class="text-danger">','</span>'); ?>
                            </div>

                            <div class="col-md-4 col-sm-4">
                              <label>Twitter Id</label>
                                <input name="client_twitter_id" class="form-control" type="text" id="client_twitter_id" value="<?php echo $res->user_twitter_id; ?>" />
                         ...
                         <div class="form-group">
                            <div class="col-md-4 col-sm-4">
                               <label>Linkedin Url</label>
                                <input name="client_linkedin_url" class="form-control" type="text" id="client_linkedin_url" value="<?php echo $res->user_linkedin_url; ?>" />
                            ...
                            <div class="col-md-6 col-sm-6">
                              <label>client Short Note<span class="text-danger">*</span></label>
                               <textarea name="client_short_note" class="form-control"><?php echo $res->user_short_note; ?></textarea>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-1">
                        <a href="<?php echo base_url();?>client" ><button type="button" class="btn btn-danger margin-top-30 margin-left-30">Cancel</button></a>
                     </div>
                  </div>
               </form>
            </div>
