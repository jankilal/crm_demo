                                        ...
                                        if(!empty($tab_list))
                                        {
                                            foreach($tab_list as $res)
                                            {
                                                ...
                                                <tr>        
                                                   ...
                                                   <td><input type="checkbox" name="all_<?php echo $res->tab_id; ?>" id="all_<?php echo $res->tab_id; ?>" value="1" onclick="checkedAllCheckbox(<?php echo $res->tab_id; ?>)" ></td>
                                                    <td><input type="checkbox" onclick="checkAllCheckBox('<?php echo $res->tab_id; ?>')" class="check_checkbox_<?php echo $res->tab_id; ?>" name="tab_<?php echo $res->tab_id; ?>" id="tab_<?php echo $res->tab_id; ?>" value="1" ></td>
                                                    <td><input type="checkbox" onclick="checkAllCheckBox('<?php echo $res->tab_id; ?>')" class="check_checkbox_<?php echo $res->tab_id; ?>" name="add_<?php echo $res->tab_id; ?>" id="add_<?php echo $res->tab_id; ?>" value="1" ></td>
                                                    <td><input type="checkbox" onclick="checkAllCheckBox('<?php echo $res->tab_id; ?>')" class="check_checkbox_<?php echo $res->tab_id; ?>" name="edit_<?php echo $res->tab_id; ?>" id="edit_<?php echo $res->tab_id; ?>" value="1" ></td>
                                                    <td><input type="checkbox" onclick="checkAllCheckBox('<?php echo $res->tab_id; ?>')" class="check_checkbox_<?php echo $res->tab_id; ?>" name="delete_<?php echo $res->tab_id; ?>" id="delete_<?php echo $res->tab_id; ?>" value="1" ></td>
                                                </tr> 
                                                <?php
                                            }
                                        }
