...
<section id="middle">
   ...
   <header id="page-header">
      <h1>TaxRate <small>Control panel</small></h1>
      <ol class="breadcrumb">
         <br>
         <li><a href="<?php echo base_url();?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
         <li><a href="<?php echo base_url();?>sales/taxRates">TaxRate</a></li>
         <li class="active">TaxRate Add</li>
      </ol>
   </header>
   <!-- /page title -->
   ...
   <div class="col-md-12">
      <div class="panel panel-default">
         <div class="panel-heading panel-heading-transparent">
            <strong>Add TaxRate</strong>
            <div class="pull-right box-tools">
               <a href="<?php echo base_url();?>sales/TaxRate" class="btn btn-teal btn-sm">Back</a>                           
            </div>
         </div>
            ...
            <div class="row">
               <div class="form-group">
                  <div class="col-md-6 col-sm-6">
                     <label>Tax Rate Name<span class="text-danger"> *</span></label>
                     <input type="text" class="form-control" name="tax_rate_name" value="">
                      <?php echo form_error('tax_rate_name','<span class="text-danger">','</span>'); ?>
                  </div>
                    <div class="col-md-6 col-sm-6">
                     <label>Tax Rate Percent <span class="text-danger"> *</span></label>
                     <input type="text" class="form-control" name="tax_rate_percent" value="">
                      <?php echo form_error('tax_rate_percent','<span class="text-danger">','</span>'); ?>
                  </div>
               </div>
            </div>
               <div class="row">
