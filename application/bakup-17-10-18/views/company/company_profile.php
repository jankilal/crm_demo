            ...
            <div class="panel-body">
               <form method="post" onsubmit="return checkProfileUpdate()" enctype="multipart/form-data" data-success="Sent! Thank you!">
                        ...
                        <div class="form-group">
                           <div class="col-md-4 col-sm-4">
                              <label>Name<span class="text-danger"> *</span></label>
                                <input name="company_name" class="form-control" type="text" id="company_name" value="<?php echo $res->user_full_name; ?>" />
                                <?php echo form_error('company_name','<span class="text-danger">','</span>'); ?>
                           </div> 
                           <div class="col-md-4 col-sm-4">
                              <label>Email<span class="text-danger"> *</span></label>
                                <input name="company_email" onchange="check_email_address(this.value)" class="form-control" type="text" id="company_email" value="<?php echo $res->user_email; ?>" />
                                <input type="hidden" id="validate_email">
                                <span style="color: red;" id="error_email"></span>
                           </div>
                            <div class="col-md-4 col-sm-4">
                              <label>company Phone<span class="text-danger"> *</span></label>
                                <input name="company_phone" class="form-control" type="text" id="company_phone" value="<?php echo $res->user_phone; ?>" />
                         ...
                         <div class="form-group"> 
                            <div class="col-md-4 col-sm-4">
                             <label>City<span class="text-danger"> *</span></label>
                                <input name="company_city" class="form-control" type="text" id="company_city" value="<?php echo $res->user_city; ?>" />
                                <?php echo form_error('company_city','<span class="text-danger">','</span>'); ?>
                           </div>
                            <div class="col-md-4 col-sm-4">
                              <label>Zip Code<span class="text-danger">*</span></label>
                                <input type="text" class="form-control masked" data-format="99999" data-placeholder="12345" placeholder="Zip code" name="company_zip_code" value="<?php echo  $res->user_zip_code; ?>"  >
                                <?php echo form_error('company_zip_code','<span class="text-danger">','</span>'); ?>
                           </div>
                            <div class="col-md-4 col-sm-4">
                              <label>Address<span class="text-danger">*</span></label>
                               <textarea name="company_address" class="form-control"><?php echo $res->user_address; ?></textarea>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4">
                              <label>company Website<span class="text-danger"></span></label>
                                <input type="text" name="company_website" placeholder="http://yourcompanysite.com" value="<?php echo $res->user_website; ?>" class="form-control">
                             ...
                             <div class="col-md-4 col-sm-4">
                               <label>Fax Number</label>
                                <input name="company_fax" class="form-control" type="text" id="company_fax" value="<?php echo $res->user_fax; ?>" />
                         ...
                         <div class="form-group">
                            <div class="col-md-4 col-sm-4">
                              <label>Skype Id<span class="text-danger"></span></label>
                                <input type="text" name="company_skype_id" value="<?php echo $res->user_skype_id;?>" class="form-control">
                                <?php echo form_error('company_skype_id','<span class="text-danger">','</span>'); ?>
                            </div>
                            <div class="col-md-4 col-sm-4">
                              <label>Facebook Url</label>
                                <input name="company_fb_id" class="form-control" type="text" id="company_fb_id" value="<?php echo $res->user_facebook_url; ?>" />
                                  <?php echo form_error('company_fb_id','<span class="text-danger">','</span>'); ?>
                            </div>

                            <div class="col-md-4 col-sm-4">
                              <label>Twitter Id</label>
                                <input name="company_twitter_id" class="form-control" type="text" id="company_twitter_id" value="<?php echo $res->user_twitter_id; ?>" />
                         ...
                         <div class="form-group">
                            <div class="col-md-4 col-sm-4">
                               <label>Linkedin Url</label>
                                <input name="company_linkedin_url" class="form-control" type="text" id="company_linkedin_url" value="<?php echo $res->user_linkedin_url; ?>" />
                            ...
                            <div class="col-md-6 col-sm-6">
                              <label>company Short Note<span class="text-danger">*</span></label>
                               <textarea name="company_short_note" class="form-control"><?php echo $res->user_short_note; ?></textarea>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-1">
                        <a href="<?php echo base_url();?>company" ><button type="button" class="btn btn-danger margin-top-30 margin-left-30">Cancel</button></a>
                     </div>
                  </div>
               </form>
            </div>
...
<script type="text/javascript">
  ...
  function checkProfileUpdate()
  {
   ...
   if($('#company_email').val() == "")
    ...
    {
      if($('#company_new_pass').val() == "")
      {         
         $('#error_new_pass').html('Password is required *');
         $("#company_new_pass").focus();
         return false;
      }
      else
      {
      ...
      if($('#company_c_new_pass').val() == "")
      {       
          $('#error_c_new_pass').html('Please enter your confirm Password.');
          $("#company_c_new_pass").focus();       
          return false;     
      }
      else
      {
          if ($('#company_c_new_pass').val() == $('#company_new_pass').val())
          {            
