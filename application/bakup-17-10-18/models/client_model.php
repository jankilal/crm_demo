...
class Client_model extends CI_Model 
{
	...
	public function getAllclient()
	{
		...
		// $this->db->join('tbl_leads b' , 'b.leads_id = a.opportunities_id');
		...
		// $this->db->select('a.* , b.country_name,c.state_name,d.lead_status,d.lead_type');
		// $this->db->from('tbl_leads a');
		// $this->db->join('tbl_country b', 'b.country_id = a.country');
	 // 	$this->db->join('tbl_state c', 'c.state_id = a.state');
	 // 	$this->db->join('tbl_lead_status d', 'd.lead_status_id = a.lead_status_id');
		// $this->db->where('current_status', '3');
		// $query = $this->db->get();
		// return $query->result() ;
	}
