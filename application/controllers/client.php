...
class Client extends MY_Controller 
{
	...
	public function index()
	{
		...
		{			
		    ...
		    {
		    	$this->data['client_result'] = $this->client_model->getAllclientByUserID(login_user);
		    }
...
// echo("<pre>"); print_r($this->data['approvedQuote']); die();
    ...
    public function viewProcessDetails($process_id='')
	{
		if ($process_id) 
		{	
			$this->data['quote_details']	= $this->comman_model->getData('tbl_quotation' , array('quote_id' => $process_id));
			$this->data['product_details']	= $this->comman_model->getData('tbl_quotation_products' , array('quote_id' => $process_id));
