	...
	public function index()
	{
		...
		{  
		    ...
		    else
		    {
		    	...
		    	$this->data['opportunities_result']     = $this->opportunities_model->getAllOpportunitiesUserlogin(login_user);
                $this->data['advance_data_tbl']  		= '1';
				$this->data['opportunities_state_list'] = $this->opportunities_model->getALLOpportunitiesStateList(login_user);		
				$this->session->unset_userdata('opportunities_process');
