              ...
              <tbody>
                ...
                <?php
                  ...
                  <?php
                   ...
                   {
                       ?>
                     <a class="confirm" onclick="return delete_lead_staus('<?php echo $res->lead_status_id;?>');" href="" title="Remove"><i class="fa fa-trash-o fa-2x text-danger" data-toggle="modal" data-target=".bs-example-modal-sm"></i></a>                                      
                <?php
                   }
                  }
                ?>  
...
<script type="text/javascript">
    function delete_lead_staus(lead_status_id)
    {

          bootbox.confirm("Are you sure you want to delete Lead Status details",function(confirmed){            
            if(confirmed)
            {
                location.href="<?php echo base_url();?>settings/deleteleadStatus/"+lead_status_id;
            }
        });
    }    
</script>