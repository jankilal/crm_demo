            ...
            <div class="col-md-9 col-lg-9">
               <div class="tabs nomargin-top">
                <div class="panel-body mail_box_custom">              
                   ...
                   <?php if(!empty($sentmail_result)){ ?>
                    <a style="display: none;" href="javascript:;" id="trashMail"><button type="submit" name="Trash" value="Trash" title="Move to trash">
                    ...
                    ?>
                      <table class="table table-striped table-bordered table-hover" id="datatable_sample">
                        ...
                        <tbody>
                        <?php
                          foreach ($sentmail_result as $ib_res) 
                          {
                            ?>
                                <tr class="odd gradeX">
                                  <td width="6%">
                                    <input type="checkbox" class="checkboxes" name="mail_checked[]" value="<?php echo $ib_res->mailbox_id; ?>"/></td>
                                  <td><?php echo $ib_res->user_full_name; ?></td>
                                  <td><?php echo $ib_res->subject; ?></td>
                                  <td><?php echo date_format(date_create_from_format('Y-m-d H:i:s', $ib_res->message_time), 'd M');?></td>                 
                                  <td width="10%"><a href="<?php echo base_url().'mailbox/sentMail/'.$ib_res->mailbox_id; ?>" class="btn btn-xs btn-default btn-bordered"><i class="fa fa-eye" style="padding: 0px;"></i></i>
                                      </a></td>                 
                                </tr>
