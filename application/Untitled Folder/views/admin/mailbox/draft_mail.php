               ...
               <div class="tabs nomargin-top">
                <div class="panel-body mail_box_custom">              
                   <a href="javascript:;" onclick="location.reload()">
                    ...
                    <?php if(!empty($draft_result)){ ?><a href="javascript:;" id="trashMail" style="display: none;" title="Delete"><button type="submit" name="Delete" value="Delete">
                    ...
                    {                      
                      ...
                      ?>
                          <table class="table table-striped table-bordered table-hover" id="datatable_sample">
                            ...
                            <tbody>
                            <?php
                            foreach ($draft_result as $ib_res) 
                            {
                              ?>
                                  <tr class="odd gradeX">
                                    <td width="6%">
                                    ...
                                    <td width="10%"><a class="btn btn-xs btn-default btn-bordered" href="<?php echo base_url().'mailbox/index/'.$ib_res->mailbox_id; ?>"><i style="padding: 0px;" class="fa fa-eye" title="View"></i></a></td>
                                  </tr>
