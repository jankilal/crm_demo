...
<section id="middle">
   ...
   <header id="page-header">
      <h1>Inprogress <small>Control panel</small></h1>
      <ol class="breadcrumb">
         <br>
         <li><a href="<?php echo base_url();?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
         <li><a href="<?php echo base_url();?>transactions/inProgress">Inprogress</a></li>
         <li class="active">Inprogress Edit</li>
      </ol>
   </header>
   <!-- /page title -->
      ...
      <div class="col-md-12">
         <div class="panel panel-default">
            <div class="panel-heading panel-heading-transparent">
               <strong>Edit Inprogress</strong>
               <div class="pull-right box-tools">
                  <a href="<?php echo base_url();?>tickets/inProgress" class="btn btn-teal btn-sm">Back</a>                           
               </div>
            </div>
            <div class="panel-body">
               <form method="post" enctype="multipart/form-data" data-success="Sent! Thank you!">
                  <fieldset>
                  <?php
                     foreach ($edit_inprogress as $res) 
                     {
                     ?>
