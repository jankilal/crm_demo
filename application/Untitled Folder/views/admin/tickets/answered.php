   ...
   <div id="content" class="padding-20">
      <div id="panel-1" class="panel panel-default">
         <div class="panel-heading">
            ...
            <strong>Answered Details</strong> 
            </span>
           <div class="pull-right box-tools">
                    <?php
                        foreach($getAllTabAsPerRole as $role)
                        {
                            ...
                            {
                                ?>
                                    <a href="<?php echo base_url();?>tickets/addanswered" class="btn btn-info btn-sm">Add New</a>              
                                <?php
                            }
                        }
                    ?>                    
         ...
         <table class="table table-striped table-bordered table-hover" id="sample_1">
            ...
            <thead>
              <tr>
               ...
               <tbody>
                <?php
                     if(!empty($answered_result))
                     {   
                         foreach($answered_result as $res)
                         {                           
                             ?>
                            <tr>
                                ...
                                <td width="10%">
                                   <?php
                                     foreach($getAllTabAsPerRole as $role)
                                     {
                                         ...
                                         {
                                             ?>
                                          <a href="<?php echo base_url();?>tickets/addanswered/<?php echo $res->tickets_id; ?>" title="Edit"><i class="fa fa-edit fa-2x "></i></a>&nbsp;&nbsp;                
                                  <?php
                                     }
                                     if($this->uri->segment(1) == $role->controller_name && $role->userDelete == '1')
                                     {
                                         ?>
                                       <a onclick="delete_Answered('<?php echo $res->tickets_id; ?>')" title="Remove"><i class="fa fa-trash-o fa-2x text-danger" data-toggle="modal" data-target=".bs-example-modal-sm"></i></a>                                      
                                  <?php
                                     }
                                    }
                                  ?> 
    ...
    function delete_Answered(tickets_id)
    {
