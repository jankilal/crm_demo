...
<section id="middle">
   ...
   <header id="page-header">
      ...
      <ol class="breadcrumb">
         ...
         <li><a href="<?php echo base_url();?>transactions/expense">Expense</a></li>
         ...
         <div class="panel panel-default">
            <div class="panel-heading panel-heading-transparent">
               ...
               <div class="pull-right box-tools">
                  <a href="<?php echo base_url();?>transactions/expense" class="btn btn-teal btn-sm">Back</a>                           
               </div>
            </div>
            <div class="panel-body">
                           ...
                           <div class="col-md-6 col-sm-6">
                              <label>Accounts<span class="text-danger"> *</span></label>
                                ...
                                <?php
                                       ...
                                       {
                                          ?>
                                         <option <?php if($ac_val->account_id == $res->account_id){ echo "selected"; } ?> value="<?php echo $ac_val->account_id; ?>"><?php echo $ac_val->account_name; ?></option>
                                        <?php 
                                       }
                                       ?>
                                </select> 
               ...
               <div class="row">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-1">
                           <a href="<?php echo base_url();?>transactions/expense" type="submit" class="btn btn-danger margin-top-30 margin-left-30">Cancel</a>
                        </div>
                     </div>
                     <?php
                        }
