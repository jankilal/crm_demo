...
<section id="middle">
   ...
   <header id="page-header">
      ...
      <ol class="breadcrumb">
         ...
         <li><a href="<?php echo base_url();?>transactions/expense">Expenses</a></li>
   ...
   <div id="content" class="padding-20">
      <div class="row">
         <div class="col-md-12">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-sm-6">
                              <label>Date <span class="text-danger"></span></label>
                                 <input type="text" class="form-control datepicker" data-format="yyyy-mm-dd" data-lang="en" data-rtl="false" name="date" value="<?php echo date('y-m-d')?>"  >    
                           </div>
                        </div>
                     </div>
                     <div class="row">
            ...
            <div class="col-md-1">
            <a href="<?php echo base_url();?>transactions/expense" type="submit" class="btn btn-danger margin-top-30">Cancel</a>
            </div>
            </div>
             </fieldset>
            </form>
