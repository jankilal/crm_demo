...
<script type="text/javascript">
   ...
   function loadAddedProduct()
   {
    console.log(selected_product_array);
      var str = 'action_get_product_by_ids='+'Get Product By Ids' + '&ids_array='+JSON.stringify(selected_product_array)+'&actionType='+'update';
         var PAGE = '<?php echo base_url(); ?>client/getLeadProductsById';
         jQuery.ajax({
             type :"POST",
             url  :PAGE,
             data : str,
   ...
   {      
      ...
      var PAGE = '<?php echo base_url(); ?>client/addNewLeadProduct';
      jQuery.ajax({
        type :"POST",
        url  :PAGE,
   ...
   function loadProductModal()
   {
    ...
    var PAGE = '<?php echo base_url(); ?>client/loadProductData';
    jQuery.ajax({
      type :"POST",
      url  :PAGE,
      data : str,
