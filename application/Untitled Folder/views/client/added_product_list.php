...
<script type="text/javascript">
	...
	$(document).on('click' , '.onAddNewProduct' , function(){
		...
		{
			var postData = 'add_new_products='+'Add New products'+'&lead_id='+'<?= $leads_process['lead_id']; ?>'+'&ids_array='+JSON.stringify(selected_product_array);
			$.post('<?= base_url().'leads/addNewLeadProduct' ?>' , postData , function( res ){
				if(res){
