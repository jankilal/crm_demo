            ...
            <div class="col-md-9 col-lg-8">
               <div class="tabs nomargin-top">
                <div class="panel-body mail_box_custom">              
                   ...
                   <a href="javascript:;" id="unfavorite" style="display: none;" title="Unfavorite" class="btn btn-xs btn-default btn-bordered favreted"><button type="submit" name="Unfav" value="Unfav"><i style="padding: 0px;" class="fa fa-star"></i></button></a>&nbsp;&nbsp;
                    ...
                    ?>
                        <table class="table table-striped table-bordered table-hover" id="datatable_sample">
                          ...
                          <tbody>
                          <?php
                            foreach ($favourites_result as $ib_res) 
                            {
                              ?>
                                  <tr class="odd gradeX">
                                    <td width="6%">
                                    ...
                                    <td width="10%"><a href=""><i class="fa fa-eye"></i></i></td>                 
                                  </tr>
