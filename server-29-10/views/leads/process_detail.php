                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="alert alert-info" style="margin-bottom: 0px; padding: 14px 0px 6px 10px;">
                                  <h4 style="line-height: 10px;">Lead Process Details</h4>
                                </div>
                                <fieldset>
                                               ...
                                               if(!empty($process_list))
                                               {
                                                   foreach($process_list as $pres)
                                                   {
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td><a href="<?php echo base_url().'leads/viewProcessDetails/'.$pres->leads_process_details_id; ?>"><i class="fa fa-eye fa-2x"></i></a></td>
                                                      </tr>
                                                    <?php
                                                       }
                                                   }
