...
class Attendance extends MY_Controller 
{
	...
	public function getAttendance()
	{
		...
		$res =  $this->comman_model->getData('tbl_attendance' , array('attendance_date'=>date("Y-m-d")), 'multi' , NULL);
		// $this->attendance_model->getAttendance($offset, $user_id, $attendance_flag_date_time);
		if(!empty($res))
		{
