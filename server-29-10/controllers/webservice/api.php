...
/*---------Expense Start-------------*/
	public function getExpense()
	{
		...
		if(isset($_POST['sync_date_time']))
		{
			...
			if($sync_date_time == 0)
			{
				$res = $this->comman_model->getData('tbl_expenses', array('user_id' => $user_id) , 'multi' , NULL);	
			}
			else
			{
				$res = $this->comman_model->getData('tbl_expenses', array('user_id' => $user_id ,'sync_date_time >' => $sync_date_time) , 'multi', NULL);
			}
